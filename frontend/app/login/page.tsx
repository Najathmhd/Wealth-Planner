...
export default function LoginPage() {
    ...
    const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        // Map email input to 'username' field for OAuth2
    ...
    async function onSubmit(e: React.FormEvent) {
        ...
        try {
            // OAuth2 expects form data encoding, but our simplified Client might need to handle this.
                ...
                <div className="glass rounded-2xl p-8 backdrop-blur-xl bg-white/40 dark:bg-black/40 border-white/20 shadow-2xl">
                    <div className="flex flex-col space-y-2 text-center mb-6">
                        ...
                        <p className="text-sm text-muted-foreground">
                            Enter your credentials to access your wealth plan
                        </p>
                    </div>
